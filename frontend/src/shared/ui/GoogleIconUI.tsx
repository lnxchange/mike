...
export function GoogleIconUI(props: SVGProps<SVGSVGElement>) {
    return (
        <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
            ...
            <path
                fill="#FBBC05"
                d="M6.39 13.86A6.01 6.01 0 0 1 6.08 12c0-.65.11-1.27.31-1.86V7.52H3.04A10 10 0 0 0 2 12c0 1.61.38 3.13 1.04 4.48l3.35-2.62Z"
            />
            <path
                fill="#EA4335"
